import { ChapterResource, ErrorCode, ErrorInfo, IGame, LoadingState } from "../../../types";
...
export class ChapterErrorHandler {
   ...
   */
  createErrorChapter(chapterId: string, errorCode: ErrorCode, errorMsg: string, details?: any): ChapterResource {
   ...
   */
  handleChapterError(chapterId: string, errorCode: ErrorCode, errorMsg: string, details?: any): ChapterResource {
    console.error(`Chapter error: [${errorCode}] ${errorMsg}`, details);
    
    // Create error chapter
    const errorChapter = this.createErrorChapter(chapterId, errorCode, errorMsg, details);
