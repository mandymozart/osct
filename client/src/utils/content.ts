/**
 * Read access to the built content (spreads, targets, entries, assets, content rules).
 * Source: `game.config.json`, generated by the content build (`scripts/`) from `content/`.
 */
